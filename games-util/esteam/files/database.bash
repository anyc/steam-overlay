...
LIBS[libform.so.6]=sys-libs/ncurses:0/6[@ABI@]
LIBS[libformw.so.5]=sys-libs/ncurses:5/5[@ABI@,unicode]
LIBS[libformw.so.6]=sys-libs/ncurses:0/6[@ABI@,unicode]
...
LIBS[libncursesw.so.6]=sys-libs/ncurses:0/6[@ABI@,unicode]
...
LIBS[libpanel.so.5]=sys-libs/ncurses:5/5[@ABI@]
LIBS[libpanel.so.6]=sys-libs/ncurses:0/6[@ABI@]
LIBS[libpanelw.so.5]=sys-libs/ncurses:5/5[@ABI@,unicode]
LIBS[libpanelw.so.6]=sys-libs/ncurses:0/6[@ABI@,unicode]
...
LIBS[libpangox-1.0.so.0]=x11-libs/pangox-compat[@ABI@]
