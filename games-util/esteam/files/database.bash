...
LIBS[libatomic.so.1]=${GCC}[@MULTILIB@]
...
LIBS[libcom_err.so.2]=sys-fs/e2fsprogs[@ABI@]
LIBS[libcrypto.so.0.9.8]=dev-libs/openssl-compat:0.9.8[@ABI@]
LIBS[libcrypto.so.1.0.0]=dev-libs/openssl-compat:1.0.0[@ABI@]
LIBS[libcrypto.so.1.1]=dev-libs/openssl-compat:1.1.1[@ABI@]
LIBS[libcrypto.so.3]=dev-libs/openssl:0/3[@ABI@]
...
LIBS[libFAudio.so.0]=app-emulation/faudio[@ABI64@]
...
LIBS[libharfbuzz.so.0]=media-libs/harfbuzz[@ABI@]
...
LIBS[libpipewire-0.3.so.0]=media-video/pipewire[@ABI@]
...
LIBS[libpulse-mainloop-glib.so.0]=media-libs/libpulse[@ABI@]
LIBS[libpulse-simple.so.0]=media-libs/libpulse[@ABI@]
LIBS[libpulse.so.0]=media-libs/libpulse[@ABI@]
...
LIBS[libss.so.2]=sys-fs/e2fsprogs[@ABI@]
LIBS[libssl.so.0.9.8]=dev-libs/openssl-compat:0.9.8[@ABI@]
LIBS[libssl.so.1.0.0]=dev-libs/openssl-compat:1.0.0[@ABI@]
LIBS[libssl.so.1.1]=dev-libs/openssl-compat:1.1.1[@ABI@]
LIBS[libssl.so.3]=dev-libs/openssl:0/3[@ABI@]
...
LIBS[libudev.so.1]=sys-apps/systemd-utils[@ABI@]
LIBS[libusb-1.0.so.0]=dev-libs/libusb:1[@ABI@]
LIBS[libuuid.so.1]=sys-apps/util-linux[@ABI@]
LIBS[libva-glx.so.1]=media-libs/libva-compat:1[@ABI@,opengl]
LIBS[libva-glx.so.2]=media-libs/libva:0/2[@ABI@,glx]
LIBS[libva-x11.so.1]=media-libs/libva-compat:1[@ABI@,X]
LIBS[libva-x11.so.2]=media-libs/libva:0/2[@ABI@,X]
LIBS[libva.so.1]=media-libs/libva-compat:1[@ABI@]
LIBS[libva.so.2]=media-libs/libva:0/2[@ABI@]
...
LIBS[libvstdlib.so]=+
LIBS[libvulkan.so.1]=media-libs/vulkan-loader[@ABI@]
