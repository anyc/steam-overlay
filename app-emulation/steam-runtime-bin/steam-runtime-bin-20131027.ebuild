...
SRC_URI="
	...
	${UBUNTU_MIRROR}/u/udev/libgudev-1.0-0_175-0ubuntu9_i386.deb
	${UBUNTU_MIRROR}/u/udev/libudev0_175-0ubuntu9_i386.deb
	"
...
src_install() {
	...
	insinto ${SR_DIR}/usr/lib32/i386-linux-gnu/
	doins ${WORKDIR}/usr/lib/i386-linux-gnu/libgudev-1.0.so.0.1.1
	ln -s libgudev-1.0.so.0.1.1 ${D}/${SR_DIR}/usr/lib32/i386-linux-gnu/libgudev-1.0.so.0 || die

	insinto ${SR_DIR}/lib32/i386-linux-gnu/
	doins ${WORKDIR}/lib/i386-linux-gnu/libudev.so.0.13.0
	ln -s libudev.so.0.13.0 ${D}/${SR_DIR}/lib32/i386-linux-gnu/libudev.so.0 || die
}
