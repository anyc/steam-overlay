...
SRC_URI="
	...
	${UBUNTU_MIRROR}/s/systemd/libgudev-1.0-0_198-0ubuntu11_i386.deb
	${UBUNTU_MIRROR}/s/systemd/libudev1_198-0ubuntu11_i386.deb
	"
...
src_install() {
	...
	doins ${WORKDIR}/lib/i386-linux-gnu/libgudev-1.0.so.0.1.3
	ln -s libgudev-1.0.so.0.1.3 ${D}/${SR_DIR}/lib32/i386-linux-gnu/libgudev-1.0.so.0 || die

	insinto ${SR_DIR}/lib32/i386-linux-gnu/
	doins ${WORKDIR}/lib/i386-linux-gnu/libudev.so.1.2.2
	ln -s libudev.so.1.2.2 ${D}/${SR_DIR}/lib32/i386-linux-gnu/libudev.so.1 || die
}
